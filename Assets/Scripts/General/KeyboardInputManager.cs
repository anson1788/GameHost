...
public class KeyboardInputManager : MonoBehaviour 
{
	...
	public enum KeyBindings {Track1 = 0, Track2, Track3, Track4, Pause,DownArrow,LeftArrow,RightArrow,space};
	private const string Default1 = "S";
	private const string Default2 = "A";
	private const string Default3 = "D";
	private const string Default4 = "M";
	private const string DefaultPause = "P";


	private const string  downArrow = "DownArrow";
	...
	public void DefaultButtonOnClick()
	{
		...
		SetKey(KeyBindings.DownArrow, (KeyCode) System.Enum.Parse(typeof(KeyCode), downArrow));
		SetKey(KeyBindings.LeftArrow, (KeyCode) System.Enum.Parse(typeof(KeyCode), leftArrow));
		SetKey(KeyBindings.RightArrow, (KeyCode) System.Enum.Parse(typeof(KeyCode), rightArrow));
		SetKey(KeyBindings.space, (KeyCode) System.Enum.Parse(typeof(KeyCode), space));
	}
	...
	void Awake()
	{
		...
		keys = new KeyCode[keyTexts.Length+4];
		...
		keys[(int) KeyBindings.DownArrow] = (KeyCode) System.Enum.Parse(typeof(KeyCode), PlayerPrefs.GetString(KeyBindings.DownArrow.ToString(), downArrow));
		keys[(int) KeyBindings.LeftArrow] = (KeyCode) System.Enum.Parse(typeof(KeyCode), PlayerPrefs.GetString(KeyBindings.LeftArrow.ToString(), leftArrow));
		keys[(int) KeyBindings.RightArrow] = (KeyCode) System.Enum.Parse(typeof(KeyCode), PlayerPrefs.GetString(KeyBindings.RightArrow.ToString(), rightArrow));
		keys[(int) KeyBindings.space]  = (KeyCode) System.Enum.Parse(typeof(KeyCode), PlayerPrefs.GetString(KeyBindings.space.ToString(), space));
